...
[图片](https://uploader.shimo.im/f/ZOIALLjUGiQOw8pA.png)
...
[图片](https://uploader.shimo.im/f/FokPXMm0RTY3RP0N.png)
...
[图片](https://uploader.shimo.im/f/NAiLdiNsuhUY6oMl.png)
...
[图片](https://uploader.shimo.im/f/uu40GIrpieAlEhjg.png)
###3.自定义Gradle
我们在Project的根目录创建一个config.gradle来统筹我们的依赖和版本信息

[图片](https://uploader.shimo.im/f/56zHs1F9pe4Lfhn4.png)
...
[图片](https://uploader.shimo.im/f/p2AtPBflBXQF3eHG.png)
...
[图片](https://uploader.shimo.im/f/YJGVOKUYctka1NMQ.png)
...
[图片](https://uploader.shimo.im/f/wr0c1ZXlFvAJd09n.png)
###5.组件的配置
组件的配置在于两方面，一方面是作为依赖，一方面作为一个独立的App

还是先来看下他的build.gradle

[图片](https://uploader.shimo.im/f/yoXWAgEctfcVLTk8.png)
...
[图片](https://uploader.shimo.im/f/Xq55Soc8HscAv1XJ.png)
...
[图片](https://uploader.shimo.im/f/ovU3c7ItpA4aPrBl.png)
...
[图片](https://uploader.shimo.im/f/qvgxVo2rTWMulE9W.png)

BaseActivity中，我们初始化了黄油刀，以及封装了View，这样的好处就是不用写这么多onCreate了，使用起来也异常的方便

[图片](https://uploader.shimo.im/f/rqjTCiXB7u0x1WYn.png)

C.BaseFragment

至于Fragment，和Activity的封装是一样的

[图片](https://uploader.shimo.im/f/WBPzWaoNki0sXDlE.png)
...
[图片](https://uploader.shimo.im/f/BIn69IDL9Z0Ar2dw.png)

这里我封装了一个帮助类提供跳转
[图片](https://uploader.shimo.im/f/8cmtBC2eO5cReF3y.png)

地址也是自己定义的
[图片](https://uploader.shimo.im/f/TjuJSy7xJY4X74S6.png)
###9.Butterknife
...
[图片](https://uploader.shimo.im/f/5RMH5aMjGeMICCXF.png)

##三.组件化的实现
这里我基于此架构写了一个仿微信UI的Demo内容，让大家更加清晰的认识组件化，那么我们先来看下预览：

[图片](https://uploader.shimo.im/f/q4YQrir6JJMDZW8i.png)

首先我们App的空壳就是引用的四个组件，每个组件中都存在一个Fragment,App Module 只是做整合，每个组件Module单独负责一个业务，并且他们都是可以单独作为Apk存在的

[图片](https://uploader.shimo.im/f/lejQkFXKiFsVp4jH.png)

我们可以全部都单独的实现运行

[图片](https://uploader.shimo.im/f/sFEJfi3ZWHcDlo4Z.png)

而在模拟器上的表现如下：
[图片](https://uploader.shimo.im/f/DiIwUpdNIvIki7YG.png)

##四.组件化的问题
###1.资源名冲突
如果资源名冲突，要么他改，要么你改，如果他改不了，那就你改，如果你也改不了，那么我们就通过Gradle去转换了，在Project的build.gradle中添加

[图片](https://uploader.shimo.im/f/FmodFTFjaSACTt4f.png)
...
[图片](https://uploader.shimo.im/f/98oZan7quqwWHmBB.png)
...
[图片](https://uploader.shimo.im/f/x7rLEcLp5bQyimlE.jpg)
